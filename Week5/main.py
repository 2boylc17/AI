...
cpd_rain = TabularCPD(variable='Rain', variable_card=2, values=[[0.59, 0.41], [0.41, 0.59]], evidence=['Winter'], evidence_card=[2])
...
model.add_cpds(cpd_winter, cpd_rain, cpd_accident, cpd_roadworks, cpd_trafficjam)
